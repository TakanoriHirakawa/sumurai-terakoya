...
public enum Constellation {
	...
	public static Constellation getType(MonthDay birthDay) {
		if (MonthDay.of(3, 20).isBefore(birthDay) && MonthDay.of(4, 20).isAfter(birthDay)) {
			...
			return Sagittarius;
		} else if (MonthDay.of(12, 22).isBefore(birthDay)
				&& (MonthDay.of(12, 31).isAfter(birthDay) || (MonthDay.of(12, 31).equals(birthDay)))) {
			return Capricorn;
		} else if ((MonthDay.of(1, 1).isBefore(birthDay) || MonthDay.of(1, 1).equals(birthDay))
				&& MonthDay.of(1, 20).isAfter(birthDay)) {
			return Capricorn;
